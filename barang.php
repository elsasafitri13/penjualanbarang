                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered first" id="barang">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Nama Barang</th>
        ...
        $(document).ready(function(){
            ...
            var barang = $('#barang').DataTable({
                ...
                "columns": [
                    ...
                    { "data": "nama_barang", width: '15%'},
                    { "data": "merk", width: '13%'},
                    { "data": "spesifikasi", width: '13%', class:'text-center'},
            ...
            barang.on( 'draw.dt', function () {
                var PageInfo = $('#barang').DataTable().page.info();
                barang.column(0, { page: 'current' }).nodes().each( function (cell, i) {
            ...
            // Menampilkan untuk modal edit data barang
            ...
            // Menampilkan untuk modal detail data barang
            $(document).on('click', '.modal_detail', function(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $('#merkk').text(data.merk);
                        $('#spesifikasii').text(data.spesifikasi);
